 ...
 */
public class WaitDeliverFrag extends Fragment {
    ...
    public static WaitDeliverFrag getInstance(){
        WaitDeliverFrag frag=new WaitDeliverFrag();
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainView=inflater.inflate(R.layout.frag_wait_deliver,null);
