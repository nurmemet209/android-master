 ...
 */
public class WaitPayFrag extends Fragment {
    ...
    public static WaitPayFrag getInstance(){
        WaitPayFrag frag=new WaitPayFrag();
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainView=inflater.inflate(R.layout.frag_wait_pay,null);
