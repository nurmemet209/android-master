 ...
 */
public class WaitEximinateFrag extends Fragment {
    ...
    public static WaitEximinateFrag getInstance(){
        WaitEximinateFrag frag=new WaitEximinateFrag();
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainView=inflater.inflate(R.layout.frag_wait_examinate,null);
