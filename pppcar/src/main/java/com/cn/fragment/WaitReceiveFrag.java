 ...
 */
public class WaitReceiveFrag extends Fragment {
    ...
    public static WaitReceiveFrag getInstance(){
        WaitReceiveFrag frag=new WaitReceiveFrag();
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mainView=inflater.inflate(R.layout.frag_wait_receive,null);
