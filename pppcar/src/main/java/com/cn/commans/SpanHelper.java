...
public class SpanHelper {
    ...
    public SpannableStringBuilder getProductNumAndTotalPrice(String proNum,String totalPrice){
        ...
        builder.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.main_text_color)), start, start+proNum.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        builder.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.main_text_color)), start, start+totalPrice.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
